...
* **📂 02 Example session:** Contains the demonstration video file.
* **📂 03 Output:** Contains the **final result** generated by the tool (exported files, reports, or modified geometry), serving as a reference to verify that the tool executed correctly.
...
<tr>
    ...
    <td>
      ...
      <br><br>
      👇 <strong>Feature Demonstration:</strong><br>
      <a href="LINK_VIDEO_SURFACE"><img src="[Sureface.webm](https://github.com/user-attachments/assets/fc723cfd-8c44-4911-9dc1-c214a383e5b1)
" width="200"></a>
    </td>
  </tr>
<tr>
